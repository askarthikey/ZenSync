            ...
            <div className="overflow-hidden">
              {projects.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <div className="mt-6">
                    <Link to="/creator-project" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700">
