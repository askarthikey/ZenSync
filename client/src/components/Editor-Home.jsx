            ...
            <div className="px-6 py-5">
              {recentAssignments.length > 0 ? (
                ...
                <div className="text-center py-6">
                  ...
                  <div className="mt-6">
                    <Link to="/discover" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
